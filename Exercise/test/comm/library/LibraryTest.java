...
class LibraryTest {
    ...
    @Test
    void testRent_WithInvalidIndex_ReturnsInvalidIndex() {
        BookRentalSystem.addBooks(new FictionBook("FTest Book", "Test Author", 1));
        BookRentalSystem.rentBooks(1);
        String output = outContent.toString();
        assertTrue(output.contains("Invalid book index"));
    }
    @Test
    void testDisplay_DisplayAllBookAndCheckIfItMatchesWithTheExpectedOutput_true() {
        BookRentalSystem.addBooks(new FictionBook("FTest Book", "Test Author", 1));
        BookRentalSystem.addBooks(new NonFictionBook("NFTest Book", "Test Author", 1));  
        ...
        String output = outContent.toString();
        assertTrue(output.contains("FTest Book"));
        assertTrue(output.contains("NFTest Book"));
    }
    @Test
    void testDisplayRentedBooks_DisplayAllRentedBookAndCheckIfItMatchesWithTheExpectedOutput_true() {
        BookRentalSystem.addBooks(new FictionBook("FTest Book", "Test Author", 1));
        BookRentalSystem.addBooks(new NonFictionBook("NFTest Book", "Test Author", 1));
        BookRentalSystem.rentBooks(0);
        String output = outContent.toString();
